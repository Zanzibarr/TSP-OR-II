...
for name in ["perfprof_heur", "perfprof_tabu", "perfprof_vns", "perfprof_benders", "perfprof_bnc", "perfprof_bnc_patch", "perfprof_hard", "perfprof_lbv1", "perfprof_lbv2"]:
    subprocess.run(shlex.split(f'python3 plotting/pp.py -X "Cost Ratio" -D , -S 2 {end_location}{name}_costs.csv {end_location}{name}_costs.png -P ""'))
    subprocess.run(shlex.split(f'python3 plotting/pp.py -X "Time Ratio" -D , -S 2 {end_location}{name}_times.csv {end_location}{name}_times.png -P ""'))
