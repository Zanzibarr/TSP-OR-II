...
\begin{algorithm}
    ...
    \end{algorithmic}
\end{algorithm}
Where the $\mbox{find\_swap}$ method finds a swap that improves the cost.
...
\begin{enumerate}
    ...
    \item[-] Looking among all possible pair of edges and returning the swap that improves the cost the most (the best swap)
\end{enumerate}
