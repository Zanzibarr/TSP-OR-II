...
As we can see, the VNS algorithm has consistently better performances than the tabu search algorith: this might be due to the fact that the tabu search algorithm requires a finer parameter tuning, while the VNS algorithm does not need any.